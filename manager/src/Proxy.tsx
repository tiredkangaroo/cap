        ...
        <div className="flex flex-col w-[50%] min-w-fit h-full justify-center">
            <div className="flex flex-row text-3xl">
                <HoverCard>
                    ...
                    <HoverCardContent className="min-w-fit w-[85%]">
                        MITM set on indicates that the proxy is responsible for
                        the TLS connection, and will use its own certificates to
                        encrypt the traffic.
                    </HoverCardContent>
                </HoverCard>
                <Switch
            ...
            <div className="flex flex-row text-3xl mt-6">
                <HoverCard>
                    ...
                    <HoverCardContent className="min-w-fit w-[85%]">
                        Real IP Header set on means that the proxy will add the
                        IP address of the client in the X-Forwarded-For header.
                    </HoverCardContent>
                </HoverCard>
                <Switch
                    className="mt-auto mb-auto ml-auto mr-2"
            ...
            <div className="flex flex-row text-3xl mt-6">
                <HoverCard>
                    ...
                    <HoverCardContent className="min-w-fit w-[85%]">
                        The lifetime of the certificate in hours. It is possible
                        to set it to less than 0 in which any new certificates
